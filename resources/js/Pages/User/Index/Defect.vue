        ...
        <div class="w-full space-y-6 lg:space-y-8">
            <div class="space-y-6 sm:space-y-8">
                ...
                >
                    ...
                    >
                        ...
                        <p
                            class="text-sm font-medium leading-tight text-primary-700 dark:text-gray-400"
                        >
                            Defect reason
                        </p>
                    </li>
            ...
            <div class="space-y-6">
                ...
                <label
                    ...
                    >Select your service requested</label
                >
                <select
                ...
                >
                    <option
                        v-for="request_type in props.request_types"
                        :key="request_type.id"
                ...
                <div class="min-w-0 flex-1 gap-14 xl:flex xl:items-center">
                    ...
                    >
                        <dl class="flex items-center gap-2.5">
                            <dt
                                class="text-base font-normal text-gray-500 dark:text-gray-400 xl:w-36"
                            >
                                Property Number:
                            </dt>
                            <dd
