        ...
        <form @submit.prevent="submit_f" class="w-full space-y-6 lg:space-y-8">
            <div class="space-y-6 sm:space-y-8">
                ...
                >
                    ...
                    >
                        <svg
                            class="h-5 w-5 text-primary-700 dark:text-primary-400"
                            aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                        ...
                        <p
                            class="text-sm font-medium leading-tight text-primary-700 dark:text-primary-400"
                        >
                            Defect reason
                        </p>
                    </li>
