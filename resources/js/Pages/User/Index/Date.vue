        ...
        <form @submit.prevent="submit_f" class="w-full space-y-6 lg:space-y-8">
            <div class="space-y-6 sm:space-y-8">
                <ol
                    ...
                    <li class="flex items-center gap-2 md:flex-1 md:flex-col md:gap-1.5 lg:flex-none">
                        ...
                        <p class="text-sm font-medium leading-tight text-primary-700 dark:text-primary-400">
                            Defect reason
                        </p>
                    </li>
            ...
            <div class="flex flex-row space-x-6">
                ...
                <div class="relative max-w-sm">
                    ...
                    <input type="date" v-model="form.date_needed" id="datepicker-actions" datepicker datepicker-buttons
                ...
                <div class="relative max-w-sm">
                    ...
                    <input type="time" id="datepicker-actions" datepicker datepicker-buttons datepicker-autoselect-today
                        timepicker timepicker-buttons timepicker-autoselect-today
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Select date" />
                </div>
            </div>

            <div class="flex justify-between pt-80">
                <!-- Previous Button -->
                <button type="submit"
