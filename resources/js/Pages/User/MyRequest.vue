...
const fetchTickets = async (id) => {
    try {
        const response = await axios.post("/view/request", { request_id: id }); // Adjust the endpoint as needed
        ...
        <div class="relative shadow-md sm:rounded-lg">
            ...
            >
                <div class="space-x-6 mb-2">
                    ...
                    >
                        <svg
                            class="w-4 h-6 text-gray-500 dark:text-gray-400 me-3"
                            aria-hidden="true"
            ...
            <div class="overflow-x-auto">
                <table
                    class="text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 w-[calc(70%+8rem)]"
                >
                    <thead
                    ...
                    >
                        <tr>
                            ...
                            <th scope="col" class="px-10 py-6">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr
                            class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
                            v-for="assets_1 in props.tickets.data"
                            :key="assets_1.id"
                        >
                            <th
                                scope="row"
                            ...
                            <td class="px-6 py-4">
                                {{
                                    assets_1.ict_inventory.ict_equipment_type
                                        .name
                                }}
                            </td>
                            <td class="px-6 py-4">
                    ...
                    <a href="#" class="font-medium text-red-600 dark:text-red-500 hover:underline ms-3">Remove</a>
                            ...
                            >
                                ...
                                <el-button
                                    plain
                                    @click="fetchTickets(assets_1.id)"
                                >
                                    View Details
                                </el-button>
                                <button
                                    v-if="props.can.deleteUser"
                                    class="relative min-w-full h-10 w-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-lg text-center align-middle font-sans text-xs font-medium uppercase text-slate-900 transition-all hover:bg-slate-900/10 active:bg-slate-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                    type="button"
                                >
                                    <span
